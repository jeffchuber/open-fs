...
mod tests {
    ...
    async fn test_metrics_latency() {
        ...
        metrics.record_read_latency(Duration::from_millis(10)).await;
        metrics.record_read_latency(Duration::from_millis(20)).await;
        metrics.record_read_latency(Duration::from_millis(30)).await;
