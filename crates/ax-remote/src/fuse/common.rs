...
impl From<super::async_bridge::FuseError> for FsOpError {
    fn from(e: super::async_bridge::FuseError) -> Self {
        match e {
            super::async_bridge::FuseError::NotFound => FsOpError::NotFound,
            super::async_bridge::FuseError::ReadOnly => FsOpError::ReadOnly,
            super::async_bridge::FuseError::IsDir => FsOpError::IsDir,
            super::async_bridge::FuseError::NotEmpty => FsOpError::NotEmpty,
            super::async_bridge::FuseError::PermissionDenied => FsOpError::ReadOnly,
...
mod tests {
    use super::*;
    use super::super::async_bridge::block_on;
