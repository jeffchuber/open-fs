    ...
    pub fn new() -> Self {
        PlainTextExtractor {
            extensions: vec![
                ...
                "rb", "php", "swift", "kt", "scala", "clj", "ex", "exs", "erl", "hs", "lua", "r",
                "jl", "pl", "pm", "sh", "bash", "zsh", "fish", "ps1", "bat", // Web
                "html", "htm", "css", "scss", "sass", "less", "vue", "svelte",
                // Config
                "json", "yaml", "yml", "toml", "ini", "cfg", "conf", "env",
                // Documentation
                "md", "markdown", "txt", "rst", "adoc", "org", // Data
                "csv", "tsv", "xml", "sql",
            ]
            .into_iter()
            .map(String::from)
...
mod tests {
    ...
    async fn test_extract_utf8() {
        ...
        let content = "Hello, world! \u{4f60}\u{597d}\u{4e16}\u{754c}";
        let result = extractor
            .extract(content.as_bytes(), "/test.txt")
            .await
            .unwrap();
